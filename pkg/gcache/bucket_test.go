...
func TestCacheTimes(t *testing.T) {
	var found bool
	tc := NewBucketCache(50*time.Millisecond, 10*time.Minute, 10)
...
func TestCacheSerialization(t *testing.T) {
	tc := NewBucketCache(DefaultExpiration, 0, 1)
...
func testFillAndSerialize(t *testing.T, tc *BucketCache) {
...
func TestFileSerialization(t *testing.T) {
	tc := NewBucketCache(5*time.Minute, 10*time.Minute, 1)
